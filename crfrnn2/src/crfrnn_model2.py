...
def get_crfrnn_model_def():
    ...
    score4 = Conv2DTranspose(2, (4, 4), strides=2, name='score4', use_bias=False)(score_fused)
    ...
    upsample = Conv2DTranspose(2, (16, 16), strides=8, name='upsample', use_bias=False)(score_final)
